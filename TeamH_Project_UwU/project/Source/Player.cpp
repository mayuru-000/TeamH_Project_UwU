...
void Player::Draw()
{
	...
	/*txtWidth[2] = GetDrawFormatStringWidthToHandle(c->textFont[1], "STAGE - %d", c->nowStage);
	DrawFormatStringToHandle(Screen::WIDTH / 2 - txtWidth[2] / 2, 0, GetColor(255, 255, 255), c->textFont[1], "STAGE - %d", c->nowStage);*/
